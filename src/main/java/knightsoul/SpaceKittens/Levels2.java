...
public class Levels2 {
    ...
    public Levels2(Context activity, int level) {
    ...
    public void level28() {
        ...
        startIntent.putExtra("balls", "75");
        startIntent.putExtra("explosionSize", "90");
        startIntent.putExtra("goal", "70");
        startIntent.putExtra("clicks", "3");

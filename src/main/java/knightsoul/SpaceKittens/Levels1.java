...
public class Levels1 {
    ...
    public Levels1(Context activity, int level) {
    ...
    public void level1() {
        ...
        startIntent.putExtra("balls", "4");
        startIntent.putExtra("explosionSize", "200");
        startIntent.putExtra("goal", "1");
        startIntent.putExtra("clicks", "1");
        startIntent.putExtra("level", "1");
        startIntent.putExtra("pack", "1");
    ...
    public void level2() {
        ...
        startIntent.putExtra("balls", "10");
        startIntent.putExtra("explosionSize", "225");
        startIntent.putExtra("goal", "6");
        startIntent.putExtra("clicks", "1");
    ...
    public void level4() {
        ...
        startIntent.putExtra("balls", "12");
        startIntent.putExtra("explosionSize", "150");
        startIntent.putExtra("goal", "7");
        startIntent.putExtra("clicks", "1");
    ...
    public void level5() {
        ...
        startIntent.putExtra("explosionSize", "125");
        startIntent.putExtra("goal", "20");
        startIntent.putExtra("clicks", "1");

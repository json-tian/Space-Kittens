...
public class levelpack2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.levelpack2);
        ...
        level[2].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),2);
                run();
        ...
        level[3].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),3);
                run();
        ...
        level[4].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),4);
                run();
        ...
        level[5].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),5);
                run();
        ...
        level[6].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),6);
                run();
        ...
        level[7].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),7);
                run();
        ...
        level[8].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),8);
                run();
        ...
        level[9].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),9);
                run();
        ...
        level[10].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),10);
                run();
        ...
        level[11].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),11);
                run();
        ...
        level[12].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),12);
                run();
        ...
        level[13].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),13);
                run();
        ...
        level[14].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),14);
                run();
        ...
        level[15].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),15);
                run();
        ...
        level[16].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),16);
                run();
        ...
        level[17].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),17);
                run();
            }
        });
        level[18].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),18);
        ...
        level[19].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),19);
                run();
            }
        });
        level[20].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),20);
                run();
        ...
        level[21].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),21);
                run();
        ...
        level[22].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),22);
                run();
        ...
        level[23].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),23);
                run();
        ...
        level[24].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),24);
                run();
        ...
        level[25].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),25);
                run();
        ...
        level[26].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),26);
                run();
        ...
        level[27].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),27);
                run();
        ...
        level[28].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),28);
                run();
        ...
        level[29].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {runBefore();
                Levels2 level = new Levels2(getApplicationContext(),29);
                run();
        ...
        level[30].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {   runBefore();
                Levels2 level = new Levels2(getApplicationContext(),30);
                run();
    ...
    public void loadData() {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        current2 = prefs.getInt("current2", 1);
        editor.commit();
    }

    public void refreshButton() {
        for (int k = current2+1; k < level.length; k ++) {
            level[k].setBackgroundResource(R.drawable.level_unclicked);
            level[k].setEnabled(false);
        }

        for (int k = 1; k < current2;k ++) {
            level[k].setBackgroundResource(R.drawable.level_button2_done);
        }
    }

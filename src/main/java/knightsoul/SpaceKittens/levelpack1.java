...
public class levelpack1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.levelpack1);
        ...
        level[2].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),2);
                run();
        ...
        level[3].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),3);
                run();
        ...
        level[4].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),4);
                run();
        ...
        level[5].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),5);
                run();
        ...
        level[6].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),6);
                run();
            }
        });
        level[7].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),7);
        ...
        level[8].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),8);
                run();
        ...
        level[9].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),9);
                run();
        ...
        level[10].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),10);
                run();
        ...
        level[11].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),11);
                run();
        ...
        level[12].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),12);
                run();
        ...
        level[13].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),13);
                run();
        ...
        level[14].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),14);
                run();
        ...
        level[15].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),15);
                run();
        ...
        level[16].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),16);
                run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),17);
            run();
        }
        });
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),18);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),19);
            run();
        }
        });
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),20);
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),21);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),22);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),23);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),24);
            run();
        ...
        level[25].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {                runBefore();
                ...
                Levels1 level = new Levels1(getApplicationContext(),25);
                run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),26);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),27);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),28);
            run();
        ...
        public void onClick(View v) {                runBefore();
            ...
            Levels1 level = new Levels1(getApplicationContext(),29);
            run();
        ...
        level[30].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                runBefore();
                Levels1 level = new Levels1(getApplicationContext(),30);
                run();
    ...
    public void loadData() {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        current1 = prefs.getInt("current1", 1);
        editor.commit();
    }

    public void refreshButton() {
        for (int k = current1+1; k < level.length; k ++) {
            level[k].setBackgroundResource(R.drawable.level_unclicked);
            level[k].setEnabled(false);
        }

        for (int k = 1; k < current1;k ++) {
            level[k].setBackgroundResource(R.drawable.level_button_done);
        }
    }
